...
function template_assign_group()
{
	...
	echo '
		<div id="awardpage">
			...
			<div id="awardassign">
				<form id="admin_form_wrapper" name="assigngroup" action="', $scripturl, '?action=admin;area=awards;sa=assigngroup;step=2" method="post" accept-charset="UTF-8">
...
function template_assign()
{
	...
	echo '
		<div id="awardpage">
			...
			<div id="awardassign">
				<form id="admin_form_wrapper" name="assign" action="', $scripturl, '?action=admin;area=awards;sa=assign;step=2" method="post" accept-charset="UTF-8">
					<div class="floatleft" style="width:22%;">
						<h3 class="category_header">
							', $txt['awards_select_badge'], '
						</h3>
...
function template_assign_mass()
{
	...
	echo '
		<div id="awardpage">
			...
			<div id="awardassign">
				...
				<div class="content">
					<form name="assigngroup" id="assigngroup" action="', $scripturl, '?action=admin;area=awards;sa=assignmass;step=2" method="post" accept-charset="UTF-8">
						<dl class="select">
							<dt></dt>
							<dd>';
	...
	echo '
				...
				<form id="admin_form_wrapper" name="assigngroup2" action="', $scripturl, '?action=admin;area=awards;sa=assignmass;step=3" method="post" accept-charset="UTF-8">
					<div class="floatleft" style="width:22%;">
						<h3 class="category_header">
							', $txt['awards_select_badge'], '
						</h3>
	...
	else
	{
		...
		echo '
								<tr>
									<td colspan="', $columns, '" class="righttext">
